...
import 'package:test_proj/UI/widgets/advanced_multi_bloc_provider.dart';
...
class FirstPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: AdvancedMultiBlocProvider(
        providers: [
          BindedBlocProvider(create: (ctx) => DummyBloc()),
          BindedBlocProviderWithHandlers<NickHandlerBloc, NickHandlerState>(
